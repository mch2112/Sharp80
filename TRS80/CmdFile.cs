...
namespace Sharp80.TRS80
{
    public class CmdFile
    {
        ...
        public CmdFile(Z80.Assembler.Assembly Assembly, string Path)
        {
            FilePath = Path;
            try
            {
        ...
        private static string MakeTitle(string FileName)
        {
            ...
            return String.Join(String.Empty, FileName.Where(c => c.IsBetween('A', 'Z')).Take(Z80.Assembler.Assembler.MAX_TITLE_LENGTH));
        }
    }
}
