...
namespace Sharp80
{
    internal partial class Lib
    {
        static Lib()
        {
            TABLE_HALF_BORROW = new bool[256, 256];
            for (int i = 0; i < 256; i++)
            {
                for (int j = 0; j < 256; j++)
                {
                    TABLE_HALF_BORROW[i, j] = ((i & 0xF) - (j & 0xF)) < 0;
                }
            }
        }
        ...
        public static readonly byte[] TWOSCOMPINVERT_APPLY_0X80_OFFSET =
        {
        ...
        public static readonly byte[] SZ = 
        {
        ...
        public static readonly byte[] SZ53P =
        {
        ...
        public static readonly byte[] SZ53 =
        {
        ...
        public static readonly byte[] F53 =
        {
            0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x08,0x08,0x08,0x08,0x08,0x08,0x08,0x08,
            0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x08,0x08,0x08,0x08,0x08,0x08,0x08,0x08,
            0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x28,0x28,0x28,0x28,0x28,0x28,0x28,0x28,
